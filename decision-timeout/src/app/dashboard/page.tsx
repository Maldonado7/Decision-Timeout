        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-6 items-center">
              <Link
                href="/history"
                className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 font-medium transition-all duration-200 hover:shadow-md"
              >
