  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div 
          className="absolute top-40 right-10 w-28 h-28 bg-purple-200 rounded-full opacity-10"
          animate={{
            y: [0, -15, 0],
            scale: [1, 1.2, 1]
          }}
        ...
        />
        <motion.div 
          className="absolute bottom-40 left-10 w-20 h-20 bg-blue-200 rounded-full opacity-10"
          animate={{
            y: [0, 20, 0],
            x: [0, 15, 0]
          }}
